...
export function getUniversityImage(){
    return "assets/images/personal/university.jpg";
}
...
export function getGreetingText( language:string ){
    ...
    if( language == "ES" ){
        return 'Hola me llamo Aristeo!';
    }else{
        return 'Hello my name is Aristeo!';
    }    
}
...
export function getSecondaryText( language:string ){
    ...
    if( language == "ES" ){
        return "Nací en Salina Cruz, Oaxaca, México, desde muy joven he practicado Taekwondo y jugado videojuegos, lo que me ayudo a tener un mejor pensamiento lógico y un gusto por la tecnología. ";
    }else{
        return "I was born in Salina Cruz, Oaxaca, Mexico, since I was young I have practiced Taekwondo and played video games, what helped me to have a better logical thinking and a taste for technology. ";
    }
}

export function getTertiaryText( language:string ){
